...
const phoneNumberHandler: Handler = {
  ...
  YesIntent() {
    ...
    const phoneNumber = phoneNumberUtilInstance.parse(
  ...
  NoIntent() {
    ...
    if (
      this.$session.$data[this.getActiveComponent()!.name].failCount ===
      this.getActiveComponent()!.config.numberOfFails
    ) {
  ...
  Sequence: {
    ...
    YesIntent() {
      ...
      const phoneNumberSequenceCount = this.$session.$data[this.getActiveComponent()!.name]
        .phoneNumberSequenceCount;
      ...
      if (phoneNumberSequenceCount === 1) {
        ...
        try {
          phoneNumber = phoneNumberUtilInstance.parse(
            this.$session.$data[this.getActiveComponent()!.name].phoneNumberRaw,
            region,
          );
        } catch (error) {
...
function formatPhoneNumber(phoneNumber: PhoneNumber) {
  const phoneNumberE164: string = phoneNumberUtilInstance.format(
    phoneNumber,
